 ...
 */
 ...
 $myArr=array("lable"=>$i_label[name],"code" => $i_code,"table" =>$i_table,"settings" =>$i_settings,"items" =>$i_items);
 //print_r($myArr);
...
?>
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-Items" role="tabpanel" aria-labelledby="pills-profItemsile-tab">';
            <table class="table table-striped">
            <thead>
              <tr>
      ...
      <pre>
      <?php
    // $myArr = array($i_code, $i_table , $i_settings,$i_items);
 ...
 // $myJSON = json_encode($myArr);
  ...
  $arryLable=array("lable"=>$i_label[name],"code" => $i_code,"table" =>$i_table,"settings" =>$i_settings,"items" =>$i_items);
 print_r($arryLable);
  echo json_encode($arryLable);?> </pre>
  </br></br></br></br>
